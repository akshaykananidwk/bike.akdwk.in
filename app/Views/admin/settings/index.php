...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="row g-3">
    ...
    <div class="col-lg-6"><div class="card h-100"><div class="card-header fw-bold">Booking &amp; Commission Rules</div><div class="card-body row g-3">
      ...
      <div class="col-md-6"><div class="form-check form-switch"><input type="checkbox" name="packages_enabled" value="1" class="form-check-input" id="pkgen" <?= (!array_key_exists('packages_enabled',$s) || $chk('packages_enabled')) ? 'checked' : '' ?>><label class="form-check-label" for="pkgen">Show tour packages on the website</label></div></div>
      <div class="col-md-6"><div class="form-check form-switch"><input type="checkbox" name="reviews_enabled" value="1" class="form-check-input" id="reven" <?= (!array_key_exists('reviews_enabled',$s) || $chk('reviews_enabled')) ? 'checked' : '' ?>><label class="form-check-label" for="reven">Ask customers for a review after each ride</label></div></div>
      <div class="col-md-6"><div class="form-check form-switch"><input type="checkbox" name="reviews_auto_approve" value="1" class="form-check-input" id="revauto" <?= $chk('reviews_auto_approve') ?>><label class="form-check-label" for="revauto">Auto-publish reviews <span class="text-muted small">(off = you approve each one)</span></label></div></div>
      <div class="col-12"><label class="form-label">Google review link <small class="text-muted">(happy customers are also asked to post it on Google)</small></label>
