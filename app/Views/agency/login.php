...
<div class="container" style="max-width:400px">
  ...
  <div class="text-center mt-3">
    <div class="text-white small mb-2">New agency? <a href="<?= e(base_url('/agency/register')) ?>" class="text-white fw-bold text-decoration-underline">List your vehicles free</a></div>
